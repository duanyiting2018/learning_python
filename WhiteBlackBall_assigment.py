...
class WhiteBlackBall :
    def __init__(self,white_Number,black_Number):
        ############################################################################
        # TODO: Initialize the WhiteBlackBall                        
        ############################################################################
#son：  
        ...
        # END OF YOUR CODE                             #
        ############################################################################
    def takeBall(self,take_white,take_black):
        # 取0白2黑：
        if take_white == 0 and take_black == 2 :            
            self.black_Number = self.black_Number - 2
            self.black_Number =self.black_Number + 1
        # 取2白0黑：
        if take_white == 2 and take_black == 0 :  
        ...
        ############################################################################
#son:
        if take_white==1 and take_black==1:
            self.black_Number-=1
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
